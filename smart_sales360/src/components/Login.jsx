          ...
          <div className="brand-logo">
            <div className="logo-icon">
              <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M35 45 L45 55 L65 35" stroke="#8B1E2D" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M30 60 L40 60 L42 70 L58 70 L60 60 L70 60" stroke="#8B1E2D" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"/>
                <circle cx="42" cy="75" r="3" fill="#8B1E2D"/>
                <circle cx="58" cy="75" r="3" fill="#8B1E2D"/>
              </svg>
            </div>
          </div>
          <h1 className="brand-title">Smart Sales <span className="title-365">365</span></h1>
